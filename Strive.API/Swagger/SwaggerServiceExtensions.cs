    ...
    public static class SwaggerServiceExtensions
    {
        public static IServiceCollection AddSwaggerDocumentation(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "Release 2.0",
                    Title = "Strive API | IBM Mental Health Challenge",
                    Description = "This API uses to the IBM Watson API to analyze the tone of a text and interfaces with user record database to keep track of user emotions",
                    Contact = new OpenApiContact { Email = "info@kirubeltolosa.com", Name = "Team Strive", Url = new Uri("https://github.com/KirubelTolosa") }                    
                });
